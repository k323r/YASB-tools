...
if __name__ == "__main__":
    ...
    wind_speed = "ws_{}".format(args.lidar_return_level)
    wind_dir = "dir_{}".format(args.lidar_return_level)
    wind_dir_corrected = "dir_{}_corr".format(args.lidar_return_level)
    ...
    tom = pd.DataFrame({'pos_x' : tom.pos_x,
                        'pos_y' : tom.pos_y,
                        'pos_z' : tom.pos_z,
    ...
    mergedData.insert(column='deflection_gradient', value=np.gradient(mergedData.deflection), loc=2)
